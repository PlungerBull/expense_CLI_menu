...
| 10.P3 | TUI — polish (theme, `?` help, command palette, pilot tests, docs) | In progress (backlog §4.1–4.7 shipped 2026-07-05/06; §4.8 + help/palette open) |
