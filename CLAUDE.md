...
**Baseline: 1150 unit tests green (2026-08-29), contract suite 12/12** against the disposable engine on `:8001` (last run 2026-08-25). Nothing has regressed and nothing blocks daily use; the one genuine defect on the queue is a pair of TUI form keys macOS eats before the terminal sees them.
