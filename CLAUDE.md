...
**Baseline: 924 unit tests green, contract suite 12/12** against the disposable engine on `:8001`. Nothing is broken and nothing is urgent.

**Open work** — all ergonomics, none of it parity: quick-add parser, shell completions, human-name resolution for reference flags, and two smaller items. One home: [docs/todo.md](docs/todo.md). Reference for what exists: [docs/cli-spec.md](docs/cli-spec.md) (commands) · [docs/tui.md](docs/tui.md) (the TUI) · [docs/decisions.md](docs/decisions.md) (why).
