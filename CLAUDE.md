...
| 10.P3 | TUI — polish (theme, `?` help, command palette, pilot tests, docs) | In progress (backlog §4 closed 2026-07-05/06; help overlay + palette open) |
